  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', padding: '40px 0', minHeight: '80vh' }}>
      <div style={{ flex: 1, maxWidth: 700, paddingRight: 40 }}>
        ...
        <div style={{ fontSize: 18, color: '#444', marginBottom: 32, lineHeight: 1.6, maxWidth: '28ch', wordBreak: 'break-word' }}>{mentor.bio}</div>
        ...
        <div style={{ marginTop: 40 }}>
          <Link to="/" style={{ color: '#1a2341', textDecoration: 'underline', fontWeight: 500 }}>&larr; Back to all mentors</Link>
        </div>
      </div>
